    	    ...
    	    <div class="x_panel">
    	        ...
    	        <div>
    	            <div class="x_content">
                        ...
                        @else
    	            		{{ Form::open(['method' => 'post','route'=>'admin.map_varient_add']) }}
    	            	@endif
                        ...
                        <div class="form-group">
                            {{ Form::label('varient_id', 'Select Varient')}}
                        
                            {!! Form::select('varient_id',array('' => 'Please Select Varient'),null, ['class' => 'form-control','id'=>'varient_id']) !!}
     ...
     <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#first_category").change(function(){
                ...
                $.ajax({
                    type:"GET",
                    url:"{{ url('/admin/Ajax/varient/')}}"+"/"+category+"",
                    success:function(data){
                        // console.log(data);
                        $("#varient_id").html("<option value=''>Please Select Varient</option>");

                        $.each( data, function( key, value ) {
                            $("#varient_id").append("<option value='"+key+"'>"+value+"</option>");
                        });
