                        ...
                        <div class="row">
                            <div class="col-12 col-xl-4">
                                <div class="site-footer__widget footer-contacts">
                                    ...
                                    <div class="footer-contacts__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer in feugiat lorem.</div><address class="footer-contacts__contacts"><dl><dt>Phone Number</dt><dd>+91 1234567890</dd></dl><dl><dt>Email Address</dt><dd>demo@example.com</dd></dl><dl><dt>Our Location</dt><dd>715 Fake Street, Guwahati 10021 ASSAM</dd></dl><dl><dt>Working Hours</dt><dd>Mon-Sat 10:00pm - 7:00pm</dd></dl></address></div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="site-footer__widget footer-newsletter">
                                    <h5 class="footer-newsletter__title">Social Platform</h5>
                    ...
                    <div class="container">
                        <div class="site-footer__bottom-row">
                            <div class="site-footer__copyright">
                                <!-- copyright -->Copyright BPLUS — Designed by <a href="https://www.webinfotech.net.in" target="_blank">Webinfotech</a>
                                <!-- copyright / end -->
                            </div>
            ...
            C11.2,9.8,11.2,10.4,10.8,10.8z" />
                ...
                <div class="add-vehicle-modal__body">
                    ...
                    <div class="add-vehicle-modal__actions">
                        <button class="btn btn-sm btn-secondary add-vehicle-modal__close-button" type="button">Cancel</button> <a href="#" class="btn btn-sm btn-primary">Add A Vehicle</a></div>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <!-- photoswipe / end -->
    <!-- scripts -->
    <script src="{{asset('m-src/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/nouislider/nouislider.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/photoswipe/photoswipe.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/photoswipe/photoswipe-ui-default.min.js')}}"></script>
    <script src="{{asset('m-src/vendor/select2/js/select2.min.js')}}"></script>
    <script src="{{asset('m-src/js/number.js')}}"></script>
    <script src="{{asset('m-src/js/main.js')}}"></script>
    <script>
      $(window).scroll(function() {    
        var scroll = $(window).scrollTop();

        if (scroll >= 100) {
            $(".site__mobile-header").addClass("fixed-header");
        } else {
            $(".site__mobile-header").removeClass("fixed-header");
        }
    });
    </script>
</body>
<!-- Mirrored from red-parts.html.themeforest.scompiler.ru/themes/blue-ltr/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Oct 2019 09:16:12 GMT -->
