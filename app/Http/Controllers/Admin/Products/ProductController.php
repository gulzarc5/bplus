...
class ProductController extends Controller
{
    ...
    public function ajaxGetLoadFormData($category,$first_category,$second_category)
    {
    	...
    	foreach ($size_id_fetch as $size_id) {
	    	...
	    	$sizes [$size_name->name] =  DB::table('add_size')
	    	...
	    	->where('add_size.category',$category)
	    	->where('add_size.first_category',$first_category)
	    	->where('add_size.second_category',$second_category)
        ...
        foreach ($varient_id_fetch as $varient_id) {
            ...
            ->where('varient_map.category',$category)
            ->where('varient_map.first_category',$first_category)
            ->where('varient_map.second_category',$second_category)
    ...
    public function ajaxGetProductList()
    {
        ...
        ->whereNull('products.deleted_at');
            ...
            ->addColumn('action', function($row){
                   ...
                   <a href="'.route('admin.product_varient_edit', [encrypt($row->id)]).'" class="btn btn-warning btn-sm">Varients</a>
    ...
    public function productSizes($product_id)
    {
       ...
       $size_id_fetch = DB::table('add_size')
        ...
        // dd($sizes_add);
        return view('admin.products.product_sizes',compact('sizes','sizes_options','sizes_add'));
    }
    ...
    public function productNewSizeAdd(Request $request)
    {
        ...
        return redirect()->route('admin.product_sizes',['product_id' => encrypt($blade_product_id)]);
    }
    ...
    public function productVarientEdit($product_id)
    {
       ...
       $varient_id_fetch = DB::table('varient_map')
        ...
        return view('admin.products.product_varients_edit',compact('product_varients','varients'));
